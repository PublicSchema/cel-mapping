use cel_mapper_core::{
    ErrorCode, PrivacyMode, PublicSchemaDirection, PublicSchemaEvaluateOptions,
    PublicSchemaEvaluationInput,
};
use cel_mapper_core::{MappingRuntime, RuntimeOptions};
use serde_json::json;

fn eval(mapping: &str, source: serde_json::Value) -> cel_mapper_core::PublicSchemaTransformOutput {
