...
fn accepts_publicschema_options(_: publicschema_mapping::PublicSchemaCompileOptions) {}
fn accepts_publicschema_direction(_: publicschema_mapping::PublicSchemaDirection) {}
fn accepts_publicschema_eval_input(_: publicschema_mapping::PublicSchemaEvaluationInput) {}
fn accepts_security_limits(_: cel_evaluator::SecurityLimits) {}
fn accepts_standalone_input(_: cel_evaluator::StandaloneExpressionInput) {}
fn accepts_error_code(_: cel_evaluator::ErrorCode) {}
fn accepts_code_registry(_: mapping_functions::codes::CodeSystemRegistry) {}
