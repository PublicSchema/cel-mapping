"""Smoke tests for the `crosswalk` extension (run after `maturin develop` in this directory)."""

import pytest

pytest.importorskip("crosswalk")

from crosswalk import CompiledMapping, MappingCompileError, MappingRuntime  # noqa: E402
