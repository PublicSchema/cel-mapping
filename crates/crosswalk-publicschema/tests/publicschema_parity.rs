use crosswalk_cel::{ErrorCode, SecurityLimits};
...
impl MappingRuntime {
    ...
    fn compile_publicschema_mapping(
        &self,
        mapping: &str,
        options: crosswalk_publicschema::PublicSchemaCompileOptions,
    ) -> Result<CompiledPublicSchemaMapping, crosswalk_cel::CompileError> {
